...
FROM OutDocLogFull
where [DocDate] > '2024-05-22'
--and DocState = '1'
and [Creator] in ('693')


--update OutDocLogFull
--set [MIR] = [DocNumClnt]
--where [DocNumIn] in ('3454320','3454321','3454322','3454323')
...
-- обработка платежей
exec [dbo].[OutDocProcessing] @InternalPaymentsOnly=0
...
--удаление платежей
exec [CBBR_RevHBPayment] @DocID = 'OR Testv 15'
...
exec [CBBR_RevHBPayment] @DocID = 'OR TEST 15.1'
exec [CBBR_RevHBPayment] @DocID = 'OR Testv 24'
exec [CBBR_RevHBPayment] @DocID = 'OR Testv 25'
exec [CBBR_RevHBPayment] @DocID = 'OR Testv 26'
